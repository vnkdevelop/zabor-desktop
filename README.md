...
ZABOR Desktop - приложение для голосового общения, P2P-звонков и трансляции экрана с низкой задержкой.

## Демо

![Главный экран ZABOR Desktop](docs/images/zabor-overview.png)

Скриншот еще не добавлен. Поместите PNG-файл интерфейса по пути `docs/images/zabor-overview.png` - ссылка выше начнет работать автоматически.

## Возможности

- Голосовые каналы на базе P2P Mesh WebRTC.
- Система друзей, профили и статусы в реальном времени.
- Трансляция экрана или камеры с адаптивным качеством.
- Нейросетевое шумоподавление DeepFilterNet 3 и Silero VAD.
- Выбор аудиоустройств и индивидуальная громкость участников.
- Скрытые достижения и геймификация.
